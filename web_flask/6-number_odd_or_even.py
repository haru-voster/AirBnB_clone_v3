...
ap = Flask(__name__)
ap.jinja_env.trim_blocks = True
ap.jinja_env.lstrip_blocks = True
...
@ap.route("/number_template/<int:n>", strict_slashes=False)
...
@ap.route("/number_odd_or_even/<int:n>", strict_slashes=False)
